...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::rename_tag,
            commands::delete_tag,
            commands::list_tag_registry,
            commands::save_tag_registry,
            commands::upsert_tag_def,
            commands::remove_tag_def,
            commands::merge_tags,
            ...
            commands::import_preset_catalog,
            commands::import_preset_persona,
            commands::list_catalog_tag_stats,
            commands::get_user_primary_tags,
            commands::set_user_primary_tags,
